...
<div class="relative bg-white overflow-hidden">
    <div class="max-w-screen-xl mx-auto">
            ...
            <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                <nav
                        ...
                        <div
                            ...
                            <div class="-mr-2 flex items-center md:hidden">
                                <button
                                    ...
                                    focus:text-gray-500 transition duration-150
                                    ease-in-out"
                                    id="main-menu"
                    ...
                    <div class="hidden md:block md:ml-10 md:pr-4">
                        ...
                        <a
                            href="#"
                            class="ml-8 font-medium text-gray-500
                        ...
                        <a
                            href="#"
                            class="ml-8 font-medium text-pink-600
                            hover:text-pink-900 transition duration-150
                            ease-in-out">
                            Log in
                        </a>
                    </div>
      ...
      -->
                    ...
                    <div
                        ...
                        <div class="px-2 pt-2 pb-3">
                            <a
                                ...
                                focus:text-gray-900 focus:bg-gray-50 transition
                        ...
                        <div>
                            <a
                                ...
                                font-medium text-pink-600 bg-gray-50
                                hover:bg-gray-100 hover:text-pink-700
                                focus:outline-none focus:bg-gray-100
                                focus:text-pink-700 transition duration-150
                                ease-in-out"
                                role="menuitem">
                                Log in
                            </a>
            ...
            <main
                class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6
                ...
                <div class="sm:text-center lg:text-left">
                    <h2
                        ...
                        Data to enrich your
                        <br class="xl:hidden" />
                        <span class="text-pink-600">online business</span>
                    </h2>
                    <p
                    ...
                    <div
                        ...
                        <div class="rounded-md shadow">
                            <a
                                ...
                                bg-pink-600 hover:bg-pink-500 focus:outline-none
                                focus:border-pink-700 focus:shadow-outline-pink
                                transition duration-150 ease-in-out md:py-4
                                md:text-lg md:px-10">
                                Get started
                            </a>
                        </div>
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                            <a
                                ...
                                class="w-full flex items-center justify-center
                                px-8 py-3 border border-transparent text-base
                                leading-6 font-medium rounded-md text-pink-700
                                bg-pink-100 hover:text-pink-600 hover:bg-pink-50
                                focus:outline-none focus:shadow-outline-pink
                                focus:border-pink-300 transition duration-150
